...
function PerimeterTrace = analysePerimeter(LabelImage,WindowSize)
%ANALYSEPERIMETER calculates curvature of object perimeter
%
%   PERIMETERTRACE = ANALYSEPERIMETER(LABELIMAGE,WINDOW)
