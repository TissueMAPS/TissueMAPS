...
class MicroscopeImageFile(DateMixIn, Model):
...
class ChannelImageFile(Model):
    ...
    def __init__(self, tpoint, zplane, site, file_map,
                 channel_layer=None, cycle=None, is_empty=False):
        '''
        Parameters
        ----------
        tpoint: int
        ...
        channel_layer: tmlib.models.ChannelLayer, optional
            parent layer to which the image file belongs (default: ``None``)
        cycle: tmlib.models.Cycle, optional
            parent cycle to which the image file belongs (default: ``None``)
    ...
    def __repr__(self):
        return (
            ...
            % (self.id, self.tpoint, self.site_id, self.channel_layer.channel.id, self.zplane)
        )
