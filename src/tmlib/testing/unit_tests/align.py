...
class TestImageAlignment(unittest.TestCase):
    ...
    def test_upper_left_alignment(self):
        aligned_ref_img = shift_and_crop(
        ...
        np.testing.assert_equal(aligned_ul_img, aligned_ref_img)
    ...
    def test_lower_right_alignment(self):
        ...
        np.testing.assert_equal(aligned_lr_img, aligned_ref_img)
    ...
    def test_upper_right_alignment(self):
        ...
        np.testing.assert_equal(aligned_ur_img, aligned_ref_img)
    ...
    def test_lower_left_aligment(self):
        ...
        np.testing.assert_equal(aligned_ll_img, aligned_ref_img)
    ...
    def test_lower_aligment(self):
        ...
        np.testing.assert_equal(aligned_lo_img, aligned_ref_img)
    ...
    def test_upper_aligment(self):
        ...
        np.testing.assert_equal(aligned_up_img, aligned_ref_img)
    ...
    def test_left_aligment(self):
        ...
        np.testing.assert_equal(aligned_le_img, aligned_ref_img)
    ...
    def test_right_aligment(self):
        ...
        np.testing.assert_equal(aligned_ri_img, aligned_ref_img)
