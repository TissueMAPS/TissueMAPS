classdef separate_mask < handle
    ...
    methods (Static)
        ...
        function [output_mask, fig] = main(input_mask, input_image, cutting_passes, ...
                                           min_cut_area, max_solidity, min_formfactor, ...
                                           min_area, max_area, selection_test_mode, ...
                                           filter_size, sliding_window_size, min_angle, ...
                                           max_radius, perimeter_test_mode, plot)
