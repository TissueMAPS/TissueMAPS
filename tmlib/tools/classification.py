...
class Classification(Classifier):
    ...
    def label_feature_data(self, feature_data, labeled_mapobjects):
        ...
        if self.use_spark:
            ...
            return self._label_feature_data_pandas(
                feature_data, labeled_mapobjects
            )
    ...
    def _label_feature_data_pandas(self, feature_data, labeled_mapobjects):
    ...
    def classify(self, unlabeled_feature_data, labeled_feature_data, method):
        ...
        if self.use_spark:
            ...
            return self._classify_pandas(
                unlabeled_feature_data, labeled_feature_data, method
            )

    def _classify_pandas(self, unlabeled_feature_data, labeled_feature_data,
            method):
    ...
    def process_request(self, submission_id, payload):
        ...
        unique_labels = self.calculate_unique_labels(predicated_labels)
